  ...
  return (
    ...
    >
      <div className="sticky top-0 h-[100svh] overflow-hidden bg-black">
        ...
        <div className="hero-copy-block absolute inset-x-0 bottom-[10vh] z-10 mx-auto max-w-[1400px] px-10">
          ...
          <div className="mt-8 grid gap-8 grid-cols-[1.15fr_0.85fr] items-end">
            ...
            <div className="hero-fade space-y-6 pb-2">
