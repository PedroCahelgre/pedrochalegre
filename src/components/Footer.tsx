...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-black px-5 pb-10 pt-16 sm:px-6 sm:pb-14 sm:pt-20 md:px-10 md:pb-16 md:pt-24">
      ...
      <div className="mx-auto max-w-[1400px]">
        <div className="flex flex-col gap-10 sm:gap-16 md:flex-row md:items-end md:justify-between">
          <div className="space-y-4 sm:space-y-5">
            ...
            <h2 className="font-display text-[clamp(1.8rem,6vw,5rem)] font-light leading-[0.9] tracking-[-0.03em] text-white">
              Pedro Chalegre
            </h2>
            <p className="text-xs uppercase tracking-[0.3em] text-blue-400/70 sm:text-sm">Full Stack Developer</p>
            <div className="flex items-center gap-3 pt-1">
              ...
              <p className="text-xs text-white/50 sm:text-sm">Recife, PE - Brasil</p>
            </div>
          </div>
