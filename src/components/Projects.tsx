...
export function Projects() {
  return (
    <section id="projects" className="relative overflow-hidden bg-black">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 py-20 sm:px-6 sm:py-28 md:px-10 md:py-40">
        <header className="mb-10 flex flex-col justify-between gap-6 sm:mb-16 sm:flex-row md:items-end">
          <div>
            <span className="section-index">Capítulo 03 — Projetos Selecionados</span>
            <h2 className="mt-5 max-w-3xl font-display text-[clamp(2rem,7vw,7rem)] font-light leading-[0.9] tracking-[-0.03em] text-white">
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="project-body">
                ...
                <h3 className="mt-3 font-display text-[clamp(1.6rem,4vw,3.6rem)] font-normal leading-[0.95] tracking-[-0.02em] text-white sm:mt-4">
                  {project.name}
                </h3>
                <p className="mt-3 max-w-md text-[14px] leading-6 text-white/62 sm:mt-4 sm:text-[15px] sm:leading-7">{project.description}</p>
                <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 sm:mt-6 sm:gap-x-5">
                  {project.tech.map((t) => (
