...
export function Cta() {
  ...
  return (
    <section ref={ref} id="contact" className="relative min-h-[100svh] overflow-hidden bg-black">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[1400px] flex-col justify-center px-5 py-24 sm:px-8 sm:py-32 md:px-10">
        <span className="section-index">Capítulo 05 — Vamos Construir</span>
        <h2 className="cta-title cta-split mt-5 max-w-5xl font-display text-[clamp(1.8rem,7vw,8.5rem)] font-light leading-[0.9] tracking-[-0.03em] text-white sm:mt-6">
          Vamos construir o seu próximo projeto.
        </h2>
        <p className="cta-fade mt-5 max-w-2xl text-[15px] leading-7 text-white/72 sm:mt-8 sm:text-lg sm:leading-8 md:text-xl">
        ...
        <div className="cta-actions cta-fade mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap">
